...
// NewToken mints a new signed JWT for the provided match/player identifiers and role.
...
// ParseToken verifies and decodes a JWT, returning the custom MatchClaims if valid.
